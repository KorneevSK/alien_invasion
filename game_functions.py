...
def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """Обновление позиции пуль и уничтожает старые пуль"""
    ...
    check_bullets_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets)

def check_bullets_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
...
def get_number_aliens(ai_settings, alien_width):
    """Вычисляет количества пришельцев в ряду"""
...
def update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """Проверяет, жостиг ли флот края экрана, после чего обновляет позиции всех пришельцев на экране"""
...
def check_high_score(stats, sb):
    """Првоеряет, появился ли новый рекорд"""
